              ...
              <FlatList
                ...
                ListFooterComponent={
                  <>
                    ...
                    <TouchableOpacity onPress={()=>navigation.navigate("Heart")} style={{borderRadius:10,borderColor:"gray",borderWidth:1,alignItems:"center",justifyContent:"center",height:70}}>
                      <Text style={{fontWeight:"bold",fontSize:20}}>Nova consulta</Text>
                    </TouchableOpacity>
                    </View>
